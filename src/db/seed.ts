...
export async function seedDemoData(): Promise<void> {
  ...
  await db.insert(rawActivity).values([{ memberId: gabby.id, source: "github", type: "commit", externalId: "seed:commit:1", content: "Add ticket module API", occurredAt: yesterday }, { memberId: gabby.id, source: "discord", type: "chat_message", externalId: "seed:message:1", content: "Still waiting on the ticket UI design review before I can proceed.", occurredAt: new Date() }]);
